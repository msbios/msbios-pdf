...
//$previousDir = '.';
//
//while (! file_exists('application.config.php')) {
//    $dir = dirname(getcwd());
//
//    if ($previousDir === $dir) {
...
//if (file_exists('development.config.php')) {
//    $appConfig = ArrayUtils::merge($appConfig, include 'development.config.php');
//}
//
...
$pdf->Output(__DIR__ . '/example_014.pdf', 'FD');
